...
const TitlesSection = ({ errors, onTitleEnBlur, register }: TitlesSectionProps) => {
  ...
  return (
    <section className="space-y-4">
      <h3 className="text-lg font-semibold">{t('admin.apartmentForm.titles.heading')}</h3>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <FormField
          error={!!errors.title_en}
          errorText={t('admin.apartmentForm.validation.required')}
          id="title_en"
          label={t('admin.apartmentForm.titles.labelEn')}
        ...
        <FormField
          ...
          errorText={t('admin.apartmentForm.validation.required')}
          id="title_ka"
          label={t('admin.apartmentForm.titles.labelKa')}
          required
          {...register('title_ka')}
        />
        <FormField
          ...
          errorText={t('admin.apartmentForm.validation.required')}
          id="title_ru"
          label={t('admin.apartmentForm.titles.labelRu')}
          required
          {...register('title_ru')}
        />
      </div>
